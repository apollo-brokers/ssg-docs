<Update label="29th August 2025">
  ...
  * Created developer [tools](https://new.website/tools) including [Open Graph Meta Tag Checker](https://new.website/tools/open-graph-meta-tags), [DNS Lookup](https://new.website/tools/dns-lookup), and [QR Code Generator](https://new.website/tools/qr-generator).
